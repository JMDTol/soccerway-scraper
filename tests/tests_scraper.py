...
class TestScraper(unittest.TestCase):
    ...
    def setUp(self):
        response = requests.get('https://us.soccerway.com/matches/2019/04/12/australia/a-league/brisbane-roar-fc/wellington-phoenix/2835039/?ICID=PL_MS_06')
    ...
    def test_team_names(self):
        self.assertEqual(scraper.team_names(self.soup),
    ...
    def test_home_cards(self):
        self.assertEqual(scraper.home_cards(self.soup),
                         ([32, 34, 83, 90], [90]))
